...
import { Camera, Delete, Edit } from "@material-ui/icons"
...
function UserInfo() {
    ...
    const { name, email, geoThought, edit } = state
    ...
    return (
        <div className="p-4 rounded bg-white text-gray-700">
            ...
            <div className="rounded-full mb-4 group relative overflow-hidden border-solid border-4 border-gray-200 m-auto w-40 h-40">
                ...
                <div className="absolute items-center justify-center w-full text-white group-hover:flex hidden cursor-pointer left-0 right-0 bottom-0 bg-opacity-75 bg-black h-20">
