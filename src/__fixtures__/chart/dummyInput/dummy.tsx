...
function Dummy() {
    return (
        <div className="py-10 text-center text-lg text-gray-600 font-medium">
            <div className="mb-3">
                <svg width="60px" className="block m-auto bg-white" height="60px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
                    <defs>
                        ...
                        <pattern id="lds-flask-patid-0.f89b8467a3f7a" patternUnits="userSpaceOnUse" x="0" y="0" width="100" height="100">
                            <rect x="0" y="0" width="100" height="100" fill="#fac090"></rect><circle cx="2" cy="0" r="2" fill="#ffffcb" transform="translate(0 65.0667)">
                    ...
                    <path fill="url(#lds-flask-patid-0.f89b8467a3f7a)" clipPath="url(#lds-flask-cpid-0.e56f9f861a5a5)" d="M59,37.3V18.9c3-0.8,5.1-3.6,5.1-6.8C64.1,8.2,61,5,57.1,5H42.9c-3.9,0-7.1,3.2-7.1,7.1c0,3.2,2.2,6,5.1,6.8v18.4c-11.9,3.8-20.6,15-20.6,28.2C20.4,81.8,33.7,95,50,95s29.6-13.2,29.6-29.6C79.6,52.2,70.9,41.1,59,37.3z"></path>
                    <path fill="none" stroke="#ff7c81" strokeWidth="5" d="M59,37.3V18.9c3-0.8,5.1-3.6,5.1-6.8C64.1,8.2,61,5,57.1,5H42.9c-3.9,0-7.1,3.2-7.1,7.1c0,3.2,2.2,6,5.1,6.8v18.4c-11.9,3.8-20.6,15-20.6,28.2C20.4,81.8,33.7,95,50,95s29.6-13.2,29.6-29.6C79.6,52.2,70.9,41.1,59,37.3z"></path>
                </svg>
            </div>
            <div className="mb-3">
                Coming soon ^-^
